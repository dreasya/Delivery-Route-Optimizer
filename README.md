...
[![Live Demo](https://img.shields.io/badge/Live%20Demo-GitHub%20Pages-blue?style=flat-square&logo=github)](https://dreasya.github.io/Delivery-Route-Optimizer)
[![Built With](https://img.shields.io/badge/Built%20With-Vanilla%20JS-yellow?style=flat-square)](https://github.com/dreasya/Delivery-Route-Optimizer)
[![Zero Dependencies](https://img.shields.io/badge/Dependencies-Zero-green?style=flat-square)](https://github.com/dreasya/Delivery-Route-Optimizer)
[![Single File](https://img.shields.io/badge/App-Single%20HTML%20File-orange?style=flat-square)](https://github.com/dreasya/Delivery-Route-Optimizer/blob/main/delivery-route-planner.html)
[![License: MIT](https://img.shields.io/badge/License-MIT-lightgrey?style=flat-square)](https://github.com/dreasya/Delivery-Route-Optimizer/blob/main/LICENSE)
...
### Option A — Live Demo
→ [dreasya.github.io/Delivery-Route-Optimizer](https://dreasya.github.io/Delivery-Route-Optimizer)

### Option B — Run Locally
```bash
# No install, no build step, no server needed
git clone https://github.com/dreasya/Delivery-Route-Optimizer
open delivery-route-planner.html   # or just double-click it
```

### Daily Workflow
```
1. Open delivery-route-planner.html
